...
@section('content')
    <section class="bg-gray-900 text-white py-20">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl font-bold text-center mb-12">Chest - Build Strong Chest Muscles</h2>
            

            <div class="flex gap-8 mt-8">
                <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden ">
                    <img src="{{ asset('image/chestpress.png') }}" alt="Strength Training" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <h3 class="text-2xl font-bold">Chest-Press</h3>
                ...
                <div class="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                    <img src="{{ asset('image/chestfly.png') }}" alt="Strength Training" class="w-full h-48 object-cover">
                    <div class="p-6">
                        <h3 class="text-2xl font-bold">Chest-Fly</h3>
                        <p class="mt-2 text-gray-300">Build muscle, increase endurance, and get stronger with our professional strength training program.</p>
                    </div>
                </div>
